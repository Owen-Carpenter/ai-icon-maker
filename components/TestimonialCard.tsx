...
export default function TestimonialCard({ quote, name, title, avatar, avatarBg }: TestimonialCardProps) {
  return (
    <div className="bg-gradient-to-br from-midnight-900/30 to-midnight-950/50 backdrop-blur-md rounded-lg p-4 sm:p-6 border border-white/10 hover:shadow-2xl hover:shadow-sunset-500/20 transition-all duration-500 w-[260px] sm:w-[300px] lg:w-[320px]">
